              ...
              <td className="p-4 whitespace-nowrap text-right">
                <div className="flex justify-end gap-3.5">
                  <Link
                    ...
                    className="text-indigo-600 hover:text-indigo-850 font-bold text-xs flex items-center gap-1 transition-colors"
                  ...
                  <Link
                    href={`/reports/${report.id}?edit=true`}
                    className="text-amber-600 hover:text-amber-800 font-bold text-xs flex items-center gap-1 transition-colors"
                  ...
                  <button
                    onClick={() => handleDuplicateReport(report.id!, report.code)}
                    className="text-emerald-600 hover:text-emerald-800 font-bold text-xs flex items-center gap-1 transition-colors"
                  ...
                  <button
                    onClick={() => handleDeleteReport(report.id!, report.code)}
                    className="text-red-600 hover:text-red-800 font-bold text-xs flex items-center gap-1 transition-colors"
