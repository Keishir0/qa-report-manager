  ...
  const menu = (
    ...
    >
      <Link
        ...
        role="menuitem"
        onClick={closeMenu}
        className="flex items-center gap-2.5 px-3.5 py-2 text-[13px] font-semibold text-accent transition-colors hover:bg-accent/10"
      >
      ...
      {canWrite && (
        <>
          <Link
            ...
            role="menuitem"
            onClick={closeMenu}
            className="flex items-center gap-2.5 px-3.5 py-2 text-[13px] font-semibold text-warn transition-colors hover:bg-warn/10"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <button
            ...
            className="flex w-full items-center gap-2.5 px-3.5 py-2 text-left text-[13px] font-semibold text-ok transition-colors hover:bg-ok/10"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <button
            ...
            className="flex w-full items-center gap-2.5 px-3.5 py-2 text-left text-[13px] font-semibold text-bad transition-colors hover:bg-bad/10"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  return (
    <div className="flex justify-end">
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-[9px] border border-line text-muted transition-colors hover:border-accent/40 hover:bg-accent/10 hover:text-accent focus:outline-none focus:ring-[3px] focus:ring-accent/30"
      >
